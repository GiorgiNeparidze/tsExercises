...
console.log(countryA, "Country A 'partial'")
...
console.log(countryB, "Country B Required")
...
// countryC.population = 60_317_117; commented because causing err :D 

console.log(countryC, "Country C the readonly country");
...
console.log(countryD, "Country D Picked")
...
console.log(countryE, "Omited selected without population")
