...
enum LanguageStatus {
    primary = "Primary",
    secondary = "Secondary",
    spanish = "I do not speak spanish",
}
interface Status {
    language: string;
...
const countryLanguages: Status[] = [
    { language: "Italian ;)", languageStatus: LanguageStatus.primary },
    { language: "English", languageStatus: LanguageStatus.secondary },
    { language: "Spanish", languageStatus: LanguageStatus.spanish },
];
